...
const router = (adminController: AdminController) => {
  const r = Router();
   ...
   */
  r.get('/analytics', auditLog('admin_analytics_view'), adminController.getAnalytics.bind(adminController));
   ...
   */
  r.post('/content', auditLog('admin_content_create'), validate([
  ...
  ]), adminController.createContent.bind(adminController));
   ...
   */
  r.post('/products', auditLog('admin_product_create'), validate([
   ...
   */
  r.post('/upload-url', auditLog('admin_upload_url_generate'), validate([
    body('fileName').isString().notEmpty(),
    body('contentType').isString().notEmpty(),
    body('folder').optional().isString(),
  ]), adminController.generateUploadUrl.bind(adminController));
   ...
   */
  r.get('/orders', validatePagination, validate([
